...
2. If your block is not part of `pin-maker`, then the text domain should be your `plugin-slug`.
...
6. The main element is `.wp-block-pin-maker-{blockname}`, and its immediate child is `.bBlocksBlockName`. Do not apply width or columns for the main element.
